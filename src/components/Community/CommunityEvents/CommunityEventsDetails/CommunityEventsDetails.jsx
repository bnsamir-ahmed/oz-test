                            ...
                            <div className="box-content">
                                ...
                                <div
                                    className="d-flex  mb-5 amenities-box-details">
                                        <div className="d-flex">
                                    <div className="amenities-box mx-1">
                                    ...
                                    <div className="amenities-box mx-1">
                                        ...
                                        {eventDetails && eventDetails.dates?.map(date=>{
                                            return (
                                                <h5 className="amenities-text">{moment(date.check_out_date).format("DD MMMM")}</h5>
                                            )
                                        })}
                                    </div>
                                    ...
                                    <div className="amenities-box mx-1">
                                        ...
                                        {eventDetails && eventDetails.dates?.map(date=>{
                                            return (
                                                <h5 className="amenities-text">{moment(date.check_out_time, 'HH:mm:ss').format("hh:mm a")}</h5>
                                            )
                                        })}
                                    </div>
