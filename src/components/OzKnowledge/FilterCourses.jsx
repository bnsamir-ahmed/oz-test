...
const FilterCourses = ({ courses_length, openFilter }) => {
  return (
    <>
      <section className="container-fluid px-70">
        <div className="row align-items-center justify-content-between">
          <div className="col-xxl-3 col-md-4 col-sm-6 text-sm-start ">
            {courses_length > 0 ? (
              <Paragraph className="filter_result mb-0 filter-deskTop-card">
          ...
          <div className="col-xxl-5 col-lg-7 col-md-8 col-sm-6">
            <div className="row justify-content-end align-items-center">
              <div className="col-6">
                <button className="filter-mob" onClick={openFilter}>
                  {" "}
                  <span className="mx-2">
                    <svg
                      width="24"
            ...
            {courses_length > 0 ? (
              <Paragraph className="filter_result mb-0 filter-mobile-card">
                <span className="count">{courses_length}</span> Results Founds
              </Paragraph>
            ) : (
              ""
