...
import filrer from '../../assets/images/amenities/Vector.svg'
        ...
        {/* {console.log(open)} */}
            ...
            <section className="container-fluid px-70 py-5">
                <div className='row g-3'>
                    ...
                    <div className= {open ? 'col-xxl-4 col-xl-3 col-lg-3 filter_side open' : 'col-xxl-4 col-xl-3 col-lg-3 filter_side '}>
                        <Layout.Sider>
                            <Menu
                                theme="light"
                                items={items}
